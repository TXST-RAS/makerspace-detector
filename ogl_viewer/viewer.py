...
def _initialize_gpu():
    """Import CuPy and CUDA bindings lazily — call this AFTER zed.open() so the
    ZED SDK can claim GPU memory for its models before CuPy creates a context."""
    global GPU_ACCELERATION_AVAILABLE, cudart, cp
    if cp is not None:
